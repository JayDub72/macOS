...
brew "binutils"												# FSF/GNU ld, ar, readelf, etc. for native development
...
## Improved shells
brew "bash"											  		# Upgrade bash to v4 instead of 3.2 (default with Mac)
brew "bash-completion2"			  				# Enables autocompleition for bash
...
# MAS requires manual log in to work correctly but will install these applications
# MAS fails with Mojave
